...
class PhasesFrame(ctk.CTkFrame):
    ...
    def create_widgets(self, textI):
        ...
        # Add and Entry field
        name_entry = ctk.CTkEntry(self, border_color="#005f99")
        name_entry.insert(0, "Name")
        name_entry.bind("<FocusIn>", lambda e: name_entry.delete("0", "end"))
        name_entry.grid(row=1, column=0, padx=5, pady=5, sticky="ew")

        # # Add the Density field
        density_entry = ctk.CTkEntry(self, border_color="#005f99")
        ...
        viscosity_entry = ctk.CTkEntry(self, border_color="#005f99")
