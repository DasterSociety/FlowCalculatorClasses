...
class ExpectedValuesFrame(ctk.CTkFrame):
    ...
    def create_widgets(self, name):
        ...
        surface_entry = ctk.CTkEntry(self)
        ...
        vel_ratio_entry = ctk.CTkEntry(self)
        ...
        fluid_index_entry = ctk.CTkEntry(self)
        ...
        channel_width_entry = ctk.CTkEntry(self)
