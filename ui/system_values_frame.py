...
class SystemValues(ctk.CTkFrame):
    ...
    def create_widgets(self, name):
        ...
        self.ca_label = ctk.CTkLabel(self, text="Capillary Number: ")
        self.ca_label.grid(row=1, column=0, padx=5, pady=5, sticky="ew")
        self.ca_label_value = ttk.Label(self, text="---")
        self.ca_label_value.grid(row=1, column=1, padx=5, pady=5, sticky="ew")

        # Add the Surface Tension label field
        self.st_label = ctk.CTkLabel(self, text="Surface Tension (N/m): ")
        self.st_label.grid(row=2, column=0, padx=5, pady=5, sticky="ew")
        self.st_label_value = ttk.Label(self, text="---")
        self.st_label_value.grid(row=2, column=1, padx=5, pady=5, sticky="ew")

        # Add the Velocity Ratio label field
        self.vr_label = ctk.CTkLabel(self, text="Uc/Ud: ")
        self.vr_label.grid(row=3, column=0, padx=5, pady=5, sticky="ew")
        self.vr_label_value = ttk.Label(self, text="---")
        self.vr_label_value.grid(row=3, column=1, padx=5, pady=5, sticky="ew")

        # Add the SELECTED FLUID
        self.fluid_label = ttk.Label(self, text="Fluid: ")
        self.fluid_label.grid(row=4, column=0, padx=5, pady=5, sticky="ew")
        self.fluid_label_name = ttk.Label(self, text="---")
        self.fluid_label_name.grid(row=4, column=1, padx=5, pady=5, sticky="ew")

        # Add the CHANNEL WIDTH
        self.channel_label = ctk.CTkLabel(self, text="Channel width (µm): ")
        self.channel_label.grid(row=5, column=0, padx=5, pady=5, sticky="ew")
        self.channel_label_value = ttk.Label(self, text="---")
        self.channel_label_value.grid(row=5, column=1, padx=5, pady=5, sticky="ew")
